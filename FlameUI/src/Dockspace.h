...
namespace FlameUI {
    ...
    public:
        ...
        Metrics GetPanelMetricsForDockingRight(const glm::vec2& panel_dimensions);
        Metrics GetPanelMetricsForDockingBottom(const glm::vec2& panel_dimensions);
        Metrics GetPanelMetricsForDockingTop(const glm::vec2& panel_dimensions);
